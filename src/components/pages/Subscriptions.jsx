...
function Subscriptions() {
  ...
  const activeUsersData = [
    { id: 1, user: 'John Doe', plan: 'Premium', status: 'Active', amount: '$25', purchasedDate: 'Oct 5, 2025' },
    { id: 2, user: 'Jane Smith', plan: 'Basic', status: 'Active', amount: '$15', purchasedDate: 'Oct 4, 2025' },
    { id: 3, user: 'Bob Johnson', plan: 'Premium', status: 'Active', amount: '$25', purchasedDate: 'Oct 3, 2025' },
    { id: 4, user: 'Alice Brown', plan: 'Basic', status: 'Active', amount: '$15', purchasedDate: 'Oct 2, 2025' },
    { id: 5, user: 'Charlie Wilson', plan: 'Premium', status: 'Active', amount: '$25', purchasedDate: 'Oct 1, 2025' },
    { id: 6, user: 'Diana Davis', plan: 'Basic', status: 'Active', amount: '$15', purchasedDate: 'Sep 30, 2025' }
  ]

  // Plans data
  const plansData = [
    { id: 1, name: 'Basic', amount: '$10', lastUpdated: 'Oct 5, 2025', status: 'Active' },
    { id: 2, name: 'Premium', amount: '$25', lastUpdated: 'Oct 5, 2025', status: 'Active' },
    { id: 3, name: 'Elite', amount: '$45', lastUpdated: 'Oct 5, 2025', status: 'InActive' }
  ]
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-separate border-spacing-0">
            <thead className="bg-gray-100">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider rounded-tl-xl">User</th>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">Purchased Date</th>
      ...
      return (
        <div className="overflow-x-auto">
          <table className="w-full border-separate border-spacing-0">
            <thead className="bg-gray-100">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider rounded-tl-xl">Plan Name</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">Amount</th>
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h1 className="text-2xl font-medium text-gray-900">Subscriptions</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              {getMetrics().map((metric, index) => (
                <div key={index} className="bg-white p-6 rounded-xl shadow-[0px_4px_12px_0px_rgba(0,0,0,0.05)] border-[#e7e7e7]">
